...
public class Login2 implements Task {
    ...
    public Login2(String strUser, String strPassword) {
        this.strUser = strUser;
        this.strPassword = strPassword;
    }


    public static Login2 onThePage(String strUser, String strPassword) {
        return Tasks.instrumented(Login2.class,strUser,strPassword);
    }
